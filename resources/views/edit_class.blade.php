      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input name="capacity" id="" cols="30" rows="5" class="form-control py-2"value="{{$class->capacity}}" ></input>
            </div>
          </div>
          <hr>
          ...
          <div class="form-group mb-3 row">
              ...
              >
              <div class="col-md-10" >
                <label for="" class="form-label">From <input type="time" class="form-control" name="time1"value="{{$class->time1}}" ></label>
                <label for="" class="form-label">To <input type="time" class="form-control" name="time2"value="{{$class->time2}}" ></label>
              </div>
            </div>
