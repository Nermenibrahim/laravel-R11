  ...
  <main>
    <div class="container my-5">
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('products.update', $product->id ) }}" method="POST" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text"  class="form-control py-2" name="title"  value="{{old('title',$product->title)}}"  />
              @error('title')
      ...
      <div class="col-sm-10">
        ...
        <img src="{{asset('assets/images/products/' .old('image',$product->image))}}" class="img-fluid product-image" alt="">
      </div>
    </div>
